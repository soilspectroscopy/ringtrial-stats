...
The ring trial instruments' variability is assessed by the performance metrics obtained from a model trained with the KSSL soil spectral library. This operation is defined as calibration transfer.
